...
public class MobirollerClickableLayout extends ConstraintLayout {
    ...
    public MobirollerClickableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public MobirollerClickableLayout(Context context, AttributeSet attrs, int defStyleAttr) {
