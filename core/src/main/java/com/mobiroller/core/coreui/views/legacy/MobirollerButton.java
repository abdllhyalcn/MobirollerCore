...
public class MobirollerButton extends ConstraintLayout {
    ...
    public MobirollerButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public MobirollerButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.MobirollerButton, 0, 0);
        try {
            backgroundColor = a.getInteger(R.styleable.MobirollerButton_mButtonBackgroundColor, 0);
            textColor = a.getInteger(R.styleable.MobirollerButton_mButtonTextColor, 0);
            hasRadius = a.getBoolean(R.styleable.MobirollerButton_mButtonHasRadius, false);
            text = a.getString(R.styleable.MobirollerButton_mButtonText);
            int iconId = a.getResourceId(R.styleable.MobirollerButton_mButtonIcon, -1);
            if (iconId != -1)
                icon = AppCompatResources.getDrawable(getContext(), iconId);
            themeColor = a.getInteger(R.styleable.MobirollerButton_mButtonColorType, -1);
        } finally {
