...
class Lanes {
    ...
    public void getChildFrame(Rect outRect, int childWidth, int childHeight, Lanes.LaneInfo laneInfo,
    ...
    public void findLane(Lanes.LaneInfo outInfo, int laneSpan, TwoWayLayoutManager.Direction direction) {
