...
public class StaggeredGridLayoutManager extends GridLayoutManager {
    ...
    protected static class StaggeredItemEntry extends BaseLayoutManager.ItemEntry {
        ...
        public static final Parcelable.Creator<StaggeredGridLayoutManager.StaggeredItemEntry> CREATOR
                = new Parcelable.Creator<StaggeredGridLayoutManager.StaggeredItemEntry>() {
            @Override
            public StaggeredGridLayoutManager.StaggeredItemEntry createFromParcel(Parcel in) {
                return new StaggeredGridLayoutManager.StaggeredItemEntry(in);
            }

            @Override
            public StaggeredGridLayoutManager.StaggeredItemEntry[] newArray(int size) {
                return new StaggeredGridLayoutManager.StaggeredItemEntry[size];
            }
        };
    }
    ...
    int getLaneSpanForPosition(int position) {
        final StaggeredGridLayoutManager.StaggeredItemEntry entry = (StaggeredGridLayoutManager.StaggeredItemEntry) getItemEntryForPosition(position);
        if (entry == null) {
    ...
    void moveLayoutToPosition(int position, int offset, Recycler recycler, State state) {
        ...
        for (int i = 0; i <= position; i++) {
            StaggeredGridLayoutManager.StaggeredItemEntry entry = (StaggeredGridLayoutManager.StaggeredItemEntry) getItemEntryForPosition(i);
            ...
            if (entry != null) {
                ...
                // this position.
                entry = (StaggeredGridLayoutManager.StaggeredItemEntry) getItemEntryForPosition(i);
    ...
    ItemEntry cacheChildLaneAndSpan(View child, Direction direction) {
        ...
        StaggeredGridLayoutManager.StaggeredItemEntry entry = (StaggeredGridLayoutManager.StaggeredItemEntry) getItemEntryForPosition(position);
        if (entry != null) {
            mTempLaneInfo.set(entry.startLane, entry.anchorLane);
        }
        ...
        if (entry == null) {
            entry = new StaggeredGridLayoutManager.StaggeredItemEntry(mTempLaneInfo.startLane, mTempLaneInfo.anchorLane,
    ...
    void cacheItemFrame(StaggeredGridLayoutManager.StaggeredItemEntry entry, Rect childFrame) {
    ...
    ItemEntry cacheChildFrame(View child, Rect childFrame) {
        StaggeredGridLayoutManager.StaggeredItemEntry entry = (StaggeredGridLayoutManager.StaggeredItemEntry) getItemEntryForPosition(getPosition(child));
        if (entry == null) {
    ...
    public boolean checkLayoutParams(RecyclerView.LayoutParams lp) {
        ...
        if (lp instanceof StaggeredGridLayoutManager.LayoutParams) {
            final StaggeredGridLayoutManager.LayoutParams staggeredLp = (StaggeredGridLayoutManager.LayoutParams) lp;
    ...
    @Override
    public StaggeredGridLayoutManager.LayoutParams generateDefaultLayoutParams() {
        if (isVertical()) {
            return new StaggeredGridLayoutManager.LayoutParams(StaggeredGridLayoutManager.LayoutParams.MATCH_PARENT, StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT);
        } else {
            return new StaggeredGridLayoutManager.LayoutParams(StaggeredGridLayoutManager.LayoutParams.WRAP_CONTENT, StaggeredGridLayoutManager.LayoutParams.MATCH_PARENT);
        }
    }

    @Override
    public StaggeredGridLayoutManager.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        final StaggeredGridLayoutManager.LayoutParams staggeredLp = new StaggeredGridLayoutManager.LayoutParams((ViewGroup.MarginLayoutParams) lp);
        if (isVertical()) {
            staggeredLp.width = StaggeredGridLayoutManager.LayoutParams.MATCH_PARENT;
            staggeredLp.height = lp.height;
        } else {
            staggeredLp.width = lp.width;
            staggeredLp.height = StaggeredGridLayoutManager.LayoutParams.MATCH_PARENT;
        }

        if (lp instanceof StaggeredGridLayoutManager.LayoutParams) {
            final StaggeredGridLayoutManager.LayoutParams other = (StaggeredGridLayoutManager.LayoutParams) lp;
    ...
    @Override
    public StaggeredGridLayoutManager.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
    ...
    public static class LayoutParams extends TwoWayView.LayoutParams {
        ...
        private void init(ViewGroup.LayoutParams other) {
            if (other instanceof StaggeredGridLayoutManager.LayoutParams) {
                final StaggeredGridLayoutManager.LayoutParams lp = (StaggeredGridLayoutManager.LayoutParams) other;
                span = lp.span;
            } else {
                span = DEFAULT_SPAN;
            }
