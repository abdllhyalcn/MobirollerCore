package com.mobiroller.core.views.dialogs;
...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    public RatingDialog(Context context, RatingDialog.Builder builder) {
        super(context);
    ...
    private void init() {
        ...
        context.getTheme().resolveAttribute(com.applyze.R.attr.colorAccent, typedValue, true);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.dialog_rating_button_negative) {
            ...
            if (builder.ratingDialogFormListener != null) {
                builder.ratingDialogFormListener.onFormSubmitted(feedback, getUserRating());
            }
    ...
    private void setRatingThresholdClearedListener() {
        builder.ratingThresholdClearedListener = new RatingDialog.Builder.RatingThresholdClearedListener() {
            @Override
    ...
    private void setRatingThresholdFailedListener() {
        builder.ratingThresholdFailedListener = new RatingDialog.Builder.RatingThresholdFailedListener() {
            @Override
    ...
    public static class Builder {
        ...
        private RatingDialog.Builder.RatingThresholdClearedListener ratingThresholdClearedListener;
        private RatingDialog.Builder.RatingThresholdFailedListener ratingThresholdFailedListener;
        private RatingDialog.Builder.RatingDialogFormListener ratingDialogFormListener;
        private RatingDialog.Builder.RatingDialogListener ratingDialogListener;
        ...
        public interface RatingDialogFormListener {
            void onFormSubmitted(String feedback, int rating);
        }
        ...
        private void initText() {
            ...
            positiveText = context.getString(R.string.rating_dialog_remind_later);
        ...
        public RatingDialog.Builder session(int session) {
            this.session = session;
            return this;
        }

        public RatingDialog.Builder threshold(float threshold) {
            this.threshold = threshold;
            return this;
        }

        public RatingDialog.Builder title(String title) {
            this.title = title;
            return this;
        }
        ...
        public RatingDialog.Builder icon(Drawable drawable) {
            this.drawable = drawable;
            return this;
        }

        public RatingDialog.Builder positiveButtonText(String positiveText) {
            this.positiveText = positiveText;
            return this;
        }

        public RatingDialog.Builder negativeButtonText(String negativeText) {
            this.negativeText = negativeText;
            return this;
        }

        public RatingDialog.Builder titleTextColor(int titleTextColor) {
            this.titleTextColor = titleTextColor;
            return this;
        }

        public RatingDialog.Builder positiveButtonTextColor(int positiveTextColor) {
            this.positiveTextColor = positiveTextColor;
            return this;
        }

        public RatingDialog.Builder negativeButtonTextColor(int negativeTextColor) {
            this.negativeTextColor = negativeTextColor;
            return this;
        }

        public RatingDialog.Builder positiveButtonBackgroundColor(int positiveBackgroundColor) {
            this.positiveBackgroundColor = positiveBackgroundColor;
            return this;
        }

        public RatingDialog.Builder negativeButtonBackgroundColor(int negativeBackgroundColor) {
            this.negativeBackgroundColor = negativeBackgroundColor;
            return this;
        }

        public RatingDialog.Builder onThresholdCleared(RatingDialog.Builder.RatingThresholdClearedListener ratingThresholdClearedListener) {
            this.ratingThresholdClearedListener = ratingThresholdClearedListener;
            return this;
        }

        public RatingDialog.Builder onThresholdFailed(RatingDialog.Builder.RatingThresholdFailedListener ratingThresholdFailedListener) {
            this.ratingThresholdFailedListener = ratingThresholdFailedListener;
            return this;
        }

        public RatingDialog.Builder onRatingChanged(RatingDialog.Builder.RatingDialogListener ratingDialogListener) {
            this.ratingDialogListener = ratingDialogListener;
            return this;
        }

        public RatingDialog.Builder onRatingBarFormSumbit(RatingDialog.Builder.RatingDialogFormListener ratingDialogFormListener) {
            this.ratingDialogFormListener = ratingDialogFormListener;
            return this;
        }

        public RatingDialog.Builder formTitle(String formTitle) {
            this.formTitle = formTitle;
            return this;
        }

        public RatingDialog.Builder formHint(String formHint) {
            this.feedbackFormHint = formHint;
            return this;
        }

        public RatingDialog.Builder formSubmitText(String submitText) {
            this.submitText = submitText;
            return this;
        }

        public RatingDialog.Builder formCancelText(String cancelText) {
            this.cancelText = cancelText;
            return this;
        }

        public RatingDialog.Builder ratingBarColor(int ratingBarColor) {
            this.ratingBarColor = ratingBarColor;
            return this;
        }

        public RatingDialog.Builder feedbackTextColor(int feedBackTextColor) {
