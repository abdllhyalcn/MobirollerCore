package com.mobiroller.core.views.behaviors;
...
public class YoutubeHeaderCustomBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public YoutubeHeaderCustomBehavior(Context context, AttributeSet attrs) {
